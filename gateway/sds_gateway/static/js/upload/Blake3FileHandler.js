/**
 * BLAKE3 hashing and duplicate checks for capture uploads.
 * Migrated from deprecated/files-upload.js.
 */
...
if (typeof window !== "undefined") {
	window.Blake3FileHandler = Blake3FileHandler;
}
if (typeof module !== "undefined" && module.exports) {
	module.exports = { Blake3FileHandler };
}
