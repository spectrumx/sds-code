/**
 * Capture upload modal: progress, chunk upload, results.
 * Migrated from deprecated/files-upload.js (FilesUploadModal).
 */
...
if (typeof window !== "undefined") {
	window.FilesUploadModal = FilesUploadModal;
}
if (typeof module !== "undefined" && module.exports) {
	module.exports = { FilesUploadModal };
}
