...
class DatasetModeManager {
    ...
    async updateDatasetDescription(descriptionField) {
        ...
        if (!descriptionField) {
            if (this.isEditMode) {
                descriptionElement.textContent =
                    this.originalDatasetData?.description ||
        ...
        const originalValue =
            this.originalDatasetData?.description || currentValue
    ...
    async updatePendingChanges() {
        if (
            !this.handler ||
            typeof this.handler.getPendingChanges !== "function"
        ) {
            return
        }
    ...
    async handleSubmit(e) {
        if (this.isEditMode) {
            ...
            return this.handler.handleSubmit
