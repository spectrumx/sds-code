...
class DatasetAuthorsUI {
    ...
    static _mountCreate(handler) {
        ...
        let authors = utils.parseAuthorsFromHiddenField(
            authorsHiddenField.value,
        )
    ...
    static _mountEdit(handler, options) {
        ...
        let originalAuthors = Array.isArray(datasetAuthors)
            ? datasetAuthors
            : []
        ...
        authorsList.addEventListener("input", (e) => {
            ...
            if (index < originalAuthors.length) {
                ...
                if (e.target.value !== originalValue) {
                    ...
                    if (
                        Object.keys(authorChanges.modified[index]).length === 0
                    ) {
        ...
        window.captureAuthorsWithDOMIds = (a) =>
            handler.captureAuthorsWithDOMIds(a)
