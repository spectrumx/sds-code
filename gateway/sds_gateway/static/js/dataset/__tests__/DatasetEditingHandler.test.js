...
describe("DatasetEditingHandler", () => {
    ...
    beforeEach(() => {
        ...
        mockConfig = mockDatasetEditingHandlerConfig({
    ...
    describe("Permission Handling", () => {
        test.each([
            ...
            "should respect %s asset permissions",
            (action, methodName, asset) => {
                editingHandler = new DatasetEditingHandler(mockConfig)
        ...
        test("should handle contributor permissions correctly", () => {
            ...
            expect(contributorHandler.permissions.canAddAsset(ownAsset)).toBe(
                true,
            )
            ...
            expect(
                contributorHandler.permissions.canRemoveAsset(otherAsset),
            ).toBe(false)
        })
    })
    ...
    describe("API Integration", () => {
        ...
        test("should handle API errors gracefully", async () => {
            ...
            await expect(
                editingHandler.loadCurrentAssets(),
