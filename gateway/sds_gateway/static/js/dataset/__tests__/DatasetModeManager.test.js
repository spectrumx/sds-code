...
describe("DatasetModeManager", () => {
    ...
    describe("Edit Mode Initialization", () => {
        ...
        test("should initialize PermissionsManager with correct config", () => {
            ...
            expect(modeManager.permissions.datasetUuid).toBe(
                "test-dataset-uuid",
            )
        })
        ...
        test("should initialize DatasetEditingHandler in edit mode", () => {
            ...
            expect(typeof modeManager.handler.markFileForRemoval).toBe(
                "function",
            )
            expect(typeof modeManager.handler.getPendingChanges).toBe(
                "function",
            )
        })
    ...
    describe("Handler Delegation", () => {
        ...
        test("should delegate to appropriate handler based on mode", () => {
            ...
            if (modeManager.isEditMode) {
                ...
                expect(typeof modeManager.handler.navigateStep).toBe(
                    "undefined",
                )
                expect(typeof modeManager.handler.validateCurrentStep).toBe(
                    "undefined",
                ...
                expect(typeof modeManager.handler.updateReviewStep).toBe(
                    "function",
                )
    ...
    describe("Backward Compatibility", () => {
        test("should set global reference only in edit mode", () => {
            ...
            // Test edit mode
            const editManager = new DatasetModeManager({
            ...
            // Test creation mode
            const creationManager = new DatasetModeManager({
                datasetUuid: null,
            })
            expect(window.datasetEditingHandler).toBeUndefined()
        })
