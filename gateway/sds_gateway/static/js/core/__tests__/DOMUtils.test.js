...
describe("DOMUtils", () => {
    ...
    describe("API-Based Rendering Methods", () => {
        ...
        describe("renderContent()", () => {
            test.each([
                ...
                async (options, expectedHtml, expectedContext) => {
                    ...
                    const result = await domUtils.renderContent(
                        mockContainer,
                        options,
                    )
        ...
        describe("renderSelectOptions()", () => {
            ...
            test("should mark current value as selected", async () => {
                ...
                await domUtils.renderSelectOptions(
                    mockContainer,
                    choices,
                    "value2",
                )
        ...
        describe("Common Error Handling", () => {
            test.each([
                ...
                [
                    "renderLoading",
                    async (container) =>
                        await domUtils.renderLoading(container),
                ...
                [
                    "renderTable",
                    async (container) =>
                        await domUtils.renderTable(container, []),
    ...
    describe("initIconDropdowns()", () => {
        ...
        beforeEach(() => {
            mockDropdownMenu = {
                classList: {
                    contains: jest.fn((cls) => cls === "dropdown-menu"),
                },
            }
