    ...
    describe("Manager Management", () => {
        ...
        test("should get manager by type", () => {
            const permissionsManager =
                lifecycleManager.getManager("permissions")

            expect(permissionsManager).toBeDefined()
        })

        test("should return undefined for non-existent manager", () => {
            const nonExistentManager =
                lifecycleManager.getManager("non-existent")
    ...
    describe("Utility Methods", () => {
        ...
        test("should wait for manager initialization", async () => {
            const managerPromise =
                lifecycleManager.waitForManager("permissions")
    ...
    describe("Modal Initialization", () => {
        ...
        beforeEach(() => {
            ...
            document.querySelectorAll = jest.fn((selector) => {
                ...
                if (selector === ".modal[data-item-type='dataset']")
                    return [mockModal]
        ...
        test("should pre-initialize all modals with proper Bootstrap config", () => {
            ...
            expect(global.window.bootstrap.Modal).toHaveBeenCalledWith(
                mockModal,
                {
                    backdrop: true,
                    keyboard: true,
