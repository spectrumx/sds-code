...
describe("AssetSearchHandler", () => {
    ...
    describe("Initialization", () => {
        ...
        test("should setup form handler reference", () => {
            ...
            expect(
                mockConfig.formHandler.setSearchHandler,
            ).toHaveBeenCalledWith(searchHandler, "captures")
        })
        ...
        test("should initialize with initial data", () => {
            const configWithInitialData = {
                ...
                initialCaptureDetails: {
                    "capture1-uuid": { name: "test capture" },
                },
            }
            ...
            expect(
                searchHandler.selectedCaptureDetails.has("capture1-uuid"),
            ).toBe(true)
        })
    })
