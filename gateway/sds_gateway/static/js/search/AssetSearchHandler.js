...
class AssetSearchHandler {
    ...
    static ListPageSearchController = class {
        ...
        buildSearchParams() {
            ...
            if (this.paramSpecs?.length) {
                params = AssetSearchHandler.buildParamsFromConfig(
                    this.paramSpecs,
                )
    ...
    initializeEnterKeyListener() {
        ...
        const searchInputs =
            this.searchForm.querySelectorAll("input[type='text']")
        for (const input of searchInputs) {
            input.addEventListener("keypress", (e) => {
                if (e.key === "Enter") {
                    e.preventDefault()
    ...
    initializeCapturesSearch() {
        ...
        searchButton.addEventListener("click", () => {
            this.currentFilters = {
                directory: document.getElementById("search_directory_captures")
                    .value,
                capture_type: document.getElementById("search_capture_type")
                    .value,
