# Generated by Django 4.2.14 on 2025-07-24 16:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_file', models.FileField(help_text='File containing the processed data', upload_to='post_processed_data/')),
                ...
                ('pipeline_step', models.CharField(blank=True, help_text='Current step in the processing pipeline', max_length=100)),
                ('capture', models.ForeignKey(help_text='The capture this processed data belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='post_processed_data', to='api_methods.capture')),
            ],
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['capture', 'processing_type'], name='api_methods_capture_beb528_idx'), models.Index(fields=['processing_status'], name='api_methods_process_fd0607_idx'), models.Index(fields=['pipeline_id'], name='api_methods_pipelin_c1ced1_idx')],
